...
dependencies {
    ...
    testFixturesApi(mn.micronaut.http.server.netty)
    ...
    testFixturesApi(mnData.micronaut.data.runtime)
    testFixturesApi(mnData.micronaut.data.spring.jpa)
    testFixturesApi(mnData.micronaut.data.hibernate.jpa)
    ...
    testFixturesImplementation(mnTest.junit.jupiter.params)
