...
public abstract class AbstractMicronautKotlinCodegen<T extends GeneratorOptionsBuilder> extends AbstractKotlinCodegen implements BeanValidationFeatures, MicronautCodeGenerator<T> {
    ...
    public void addOperationToGroup(String tag, String resourcePath, Operation operation, CodegenOperation co,
        ...
        var foundTag = co.tags.stream()
            ...
            .orElse(null);
        if (foundTag != null) {
            co.vendorExtensions.put("normalizedBaseTag", normalizeStr(foundTag.getName()));
            ...
            if (CONTENT_TYPE_APPLICATION_FORM_URLENCODED.equals(op.vendorExtensions.get(VendorExtension.X_CONTENT_TYPE.getName()))) {
                ...
                for (var param : op.allParams) {
                    if (param.isFormParam) {
                        ...
                        if (param.isEnum) {
                            addEnumParamsForConverters(modelPackage, param, converterCounters, enumParams, enumImports, true);
                        }
                    }
                }
                op.formParams.forEach(p -> {
                    ...
                    if (p.isEnum) {
                        addEnumParamsForConverters(modelPackage, p, converterCounters, enumParams, enumImports, true);
                    }
                });
                op.formParams.clear();
            }
