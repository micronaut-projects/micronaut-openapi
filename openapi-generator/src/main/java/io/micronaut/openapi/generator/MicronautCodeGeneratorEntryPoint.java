...
public final class MicronautCodeGeneratorEntryPoint {
    ...
    private void configureJavaServerOptions() {
        if (javaServerOptions != null && codeGenerator instanceof JavaMicronautServerCodegen javaServerCodegen) {
            ...
            javaServerCodegen.setUserParameterClass(javaServerOptions.userParameterClass());
    ...
    private void configureKotlinServerOptions() {
        if (kotlinServerOptions != null && codeGenerator instanceof KotlinMicronautServerCodegen kotlinServerCodegen) {
            ...
            kotlinServerCodegen.setUserParameterClass(kotlinServerOptions.userParameterClass());
            ...
            kotlinServerCodegen.setNonPublicApi(kotlinServerOptions.nonPublicApi());
        }
    }
    ...
    private static final class DefaultBuilder implements MicronautCodeGeneratorBuilder {
        ...
        private static final class DefaultOptionsBuilder implements MicronautCodeGeneratorOptionsBuilder {
