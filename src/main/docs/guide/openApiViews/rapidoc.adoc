...
| `rapidoc.copy-resources` | Copy or not local JS and CSS resources. Set to `false` if you are using external resources (e.g. https://unpkg.com/rapidoc/dist/). Default `true`
| `rapidoc.style` |
| `rapidoc.sort-tags` |
