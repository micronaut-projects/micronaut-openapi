...
# You need to set these classes only if you use custom endpoints or replace
# standard micronaut endpoint implementations
...
# if you want to move endpoints to different file / files
endpoints.groups=management
----
