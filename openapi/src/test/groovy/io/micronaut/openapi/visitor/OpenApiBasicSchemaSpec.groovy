...
''')
    ...
    void "test required correctly results in setting required to true or false"() {
        when:
        buildBeanDefinition("test.MyBean", '''
package test;
...
class Person {
    ...
    @Schema(required = true, description = "debtValue")
    private Integer debtValue;

    @Schema(description = "totalGoals")
    private Integer totalGoals;
...
''')
        ...
        openAPI.components.schemas["Person"].properties["name"].type == "string"
        openAPI.components.schemas["Person"].properties["name"].required.contains("false")

        openAPI.components.schemas["Person"].properties["debtValue"].type == "integer"
        openAPI.components.schemas["Person"].properties["debtValue"].required.contains("true")
