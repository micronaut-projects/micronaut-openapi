...
class OpenApiOutputCustomFileNameSpec extends AbstractOpenApiTypeElementSpec {
    ...
    void "test default filename"() {
        ...
        given:
        System.setProperty(OpenApiConfigProperty.MICRONAUT_OPENAPI_FILENAME, "my-openapi-\${version}")
...
''')
        ...
        cleanup:
        System.clearProperty(OpenApiConfigProperty.MICRONAUT_OPENAPI_FILENAME);
    }
