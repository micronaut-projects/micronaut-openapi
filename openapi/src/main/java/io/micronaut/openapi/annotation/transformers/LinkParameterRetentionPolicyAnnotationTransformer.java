 ...
 * @since 2.1
 */
public class LinkParameterRetentionPolicyAnnotationTransformer extends AbstractRetentionPolicyAnnotationTransformer<LinkParameter> {

    /**
     * Changes the Retention Policy of the annotation to SOURCE.
     */
    public LinkParameterRetentionPolicyAnnotationTransformer() {
        super(LinkParameter.class);
    }
}
