 ...
 * @since 6.7.0
 */
public class DependentSchemasRetentionPolicyAnnotationTransformer extends AbstractRetentionPolicyAnnotationTransformer<DependentSchemas> {

    /**
     * Changes the Retention Policy of the annotation to SOURCE.
     */
    public DependentSchemasRetentionPolicyAnnotationTransformer() {
        super(DependentSchemas.class);
    }
}
