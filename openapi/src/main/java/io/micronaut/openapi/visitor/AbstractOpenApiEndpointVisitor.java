                ...
                if (permitsRequestBody) {
                    ...
                    if (requestBody.getContent() == null) {
                        ...
                        if (consumesMediaTypes.isEmpty()) {
                            content = buildContent(parameter, parameterType, Collections.singletonList(MediaType.APPLICATION_JSON_TYPE), openAPI,
                                    context);
                        } else {
