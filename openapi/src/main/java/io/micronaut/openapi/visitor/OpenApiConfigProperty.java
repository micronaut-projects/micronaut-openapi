...
public interface OpenApiConfigProperty {
    ...
    /**
     * Javadoc / KDoc format mode. Available values:
     * <p>
     * PLAIN - read docs without any conversion (as-is)
     * HTML_TO_MD - read docs as HTML and convert them to Markdown format
     * MD_TO_HTML - read docs as Markdown and convert them to HTML format
     * <p>
     * Default: HTML_TO_MD
     */
    String MICRONAUT_OPENAPI_DOCS_FORMAT = "micronaut.openapi.docs.format";
     ...
     * Available values: "USE_DEFAULTS" and "ALWAYS"
     * <p>
     ...
     */
    String MICRONAUT_OPENAPI_TAG_GENERATION_BY_PACKAGE_ENABLED = "micronaut.openapi.tag.generation.by.package.enabled";
    /**
     * Maximal generated tag description length. Description generated by Javadoc / KDoc on controller class level.
     */
    ...
    /**
     * List of prefixes which need to remove for generated tags. For example, if you generate tags by package,
     * you need to remove package prefix like this `com.mycompany.myservice.controller`.
     */
    String MICRONAUT_OPENAPI_TAG_GENERATION_REMOVE_PREFIXES = "micronaut.openapi.tag.generation.remove.prefixes";
    /**
     * List of postfixes which need to remove for generated tags. For example, if you generate tags by class,
     * you need to remove postfixes like `Controller` or `Api`.
     */
    String MICRONAUT_OPENAPI_TAG_GENERATION_REMOVE_POSTFIXES = "micronaut.openapi.tag.generation.remove.postfixes";
    ...
    Set<String> ALL = Set.of(
        ...
        MICRONAUT_OPENAPI_TAG_GENERATION_BY_CLASS_ENABLED,
        MICRONAUT_OPENAPI_TAG_GENERATION_BY_PACKAGE_ENABLED,
        MICRONAUT_OPENAPI_TAG_GENERATION_DESCRIPTION_MAX_LENGTH,
        MICRONAUT_OPENAPI_TAG_GENERATION_REMOVE_PREFIXES,
        MICRONAUT_OPENAPI_TAG_GENERATION_REMOVE_POSTFIXES,
        MICRONAUT_OPENAPI_TAG_GENERATION_NAMING_STRATEGY,
